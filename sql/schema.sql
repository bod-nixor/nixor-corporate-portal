...
CREATE TABLE connect_google_identities (
  id INT AUTO_INCREMENT PRIMARY KEY,
  user_id INT NULL,
...
CREATE TABLE connect_user_memberships (
  id INT AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE connect_resource_mappings (
  id INT AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE connect_entitlement_outbox (
